...
class data:
  ...
  encounters = ["monster_ambush", "item_discovery", "hidden_area", "npc_found"]
  ...
  hidden_areas = [
      hidden_areas("Minotaurs Maze",12,"Minotaur","maze","sleeping","Minotaurs Horn","Charisma"),
      hidden_areas("Gorgon's Cave",12,"Gorgon","cave","dead","Gorgon's Head","Perception")
  ]
  npcs = [
